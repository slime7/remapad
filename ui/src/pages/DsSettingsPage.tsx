/**
 * DS4、DS5 设置页（排在系统信息页之前）：
 * 位于四叶草中心区域 (130 × 130)。
 * 布局：标题 + 两行「选项名 + 开关」，开关见 components/Switch（可点区域 40 × 40，
 * 行高因此是 40，两行之间留 10 的行距）；屏幕上只放选项名，行为说明在外部文档里
 * （触摸板加减：左半减号、右半加号；截图键：开着时触摸板按下发截图，关掉改发减号，
 * 见 docs/adr/0047-ds-behavior-settings.md）。
