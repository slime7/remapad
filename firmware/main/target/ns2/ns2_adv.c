...
static const uint8_t s_template[NS2_ADV_PAYLOAD_LEN] = {
  0x02, 0x01, 0x06, 0x1B, 0xFF, 0x53, 0x05, 0x01, 0x00, 0x03, 0x7E, 0x05, 0x00, 0x00, 0x00, 0x01,
...
void ns2_adv_payload(uint8_t out[NS2_ADV_PAYLOAD_LEN], uint16_t pid, ns2_adv_mode_t mode, const uint8_t host_mac[6])
{
  ...
  out[5 + NS2_ADV_MFR_STATUS_OFFSET] = mode == NS2_ADV_WAKE ? NS2_ADV_STATUS_WAKE : NS2_ADV_STATUS_NORMAL;
}
