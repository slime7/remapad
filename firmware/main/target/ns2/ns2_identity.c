...
{
  const uint32_t low = (uint32_t)own_mac[0] | ((uint32_t)own_mac[1] << 8) | ((uint32_t)own_mac[2] << 16);
  const uint32_t high = (uint32_t)own_mac[3] | ((uint32_t)own_mac[4] << 8) | ((uint32_t)own_mac[5] << 16);
