...
static const ble_uuid128_t uuid_svc_vendor =
    BLE_UUID128_INIT(0x80, 0xd2, 0x6b, 0xf9, 0x56, 0x19, 0x51, 0x8f, 0x30, 0x4e, 0x64, 0x19, 0x5d, 0xaf, 0xc5, 0x00);
static const ble_uuid128_t uuid_base_status =
    BLE_UUID128_INIT(0x81, 0xd2, 0x6b, 0xf9, 0x56, 0x19, 0x51, 0x8f, 0x30, 0x4e, 0x64, 0x19, 0x5d, 0xaf, 0xc5, 0x00);
static const ble_uuid128_t uuid_base_config =
    BLE_UUID128_INIT(0x82, 0xd2, 0x6b, 0xf9, 0x56, 0x19, 0x51, 0x8f, 0x30, 0x4e, 0x64, 0x19, 0x5d, 0xaf, 0xc5, 0x00);
static const ble_uuid128_t uuid_device_id =
    BLE_UUID128_INIT(0x83, 0xd2, 0x6b, 0xf9, 0x56, 0x19, 0x51, 0x8f, 0x30, 0x4e, 0x64, 0x19, 0x5d, 0xaf, 0xc5, 0x00);
static const ble_uuid128_t uuid_svc_hid =
    BLE_UUID128_INIT(0xd0, 0x7f, 0xdf, 0x09, 0x8f, 0x11, 0x8f, 0x82, 0xad, 0x49, 0xfe, 0x89, 0xbe, 0xe9, 0x7d, 0xab);
static const ble_uuid128_t uuid_input05 =
    BLE_UUID128_INIT(0xd2, 0x7f, 0xdf, 0x09, 0x8f, 0x11, 0x8f, 0x82, 0xad, 0x49, 0xfe, 0x89, 0xbe, 0xe9, 0x7d, 0xab);
static const ble_uuid128_t uuid_input09 =
    BLE_UUID128_INIT(0xf8, 0xc0, 0xfc, 0x5f, 0x75, 0x32, 0x58, 0x82, 0x19, 0x46, 0x3e, 0xec, 0x6c, 0x86, 0x92, 0x74);
static const ble_uuid128_t uuid_rumble =
    BLE_UUID128_INIT(0x05, 0x2b, 0xf7, 0x31, 0x0c, 0x63, 0x39, 0xa9, 0x7d, 0x42, 0x58, 0x92, 0x51, 0x3f, 0x48, 0xcc);
static const ble_uuid128_t uuid_cmd =
    BLE_UUID128_INIT(0x05, 0xf0, 0xe5, 0x4f, 0xa5, 0x1e, 0x44, 0xaf, 0x6c, 0x4e, 0xb7, 0x8e, 0xc9, 0x4a, 0x9d, 0x64);
static const ble_uuid128_t uuid_composite =
    BLE_UUID128_INIT(0x79, 0xb3, 0xe8, 0x09, 0x98, 0x6f, 0xaf, 0x8e, 0xb5, 0x40, 0x55, 0x69, 0x7e, 0xbc, 0xac, 0x3d);
static const ble_uuid128_t uuid_fwupg =
    BLE_UUID128_INIT(0x8d, 0x9f, 0xf5, 0x5d, 0x3e, 0xd2, 0xf7, 0xa4, 0xf7, 0x4d, 0xae, 0xfd, 0x3d, 0x42, 0x47, 0x41);
static const ble_uuid128_t uuid_answer =
    BLE_UUID128_INIT(0x6a, 0x83, 0x11, 0xb1, 0x15, 0x53, 0x0a, 0xa2, 0x36, 0x4d, 0xd8, 0xd9, 0x61, 0xa9, 0x65, 0xc7);
static const ble_uuid128_t uuid_answer2 =
    BLE_UUID128_INIT(0xe0, 0x57, 0x76, 0xa7, 0x6b, 0x32, 0x49, 0xa5, 0x95, 0x4e, 0x78, 0x42, 0x7d, 0x9f, 0x6d, 0x50);
static const ble_uuid128_t uuid_ext22 =
    BLE_UUID128_INIT(0x80, 0x2a, 0x6d, 0x40, 0x6f, 0xf8, 0x15, 0xab, 0x41, 0x42, 0x1c, 0x84, 0xd2, 0x69, 0xbd, 0xd3);
static const ble_uuid128_t uuid_ext26 =
    BLE_UUID128_INIT(0xde, 0x7f, 0xdf, 0x09, 0x8f, 0x11, 0x8f, 0x82, 0xad, 0x49, 0xfe, 0x89, 0xbe, 0xe9, 0x7d, 0xab);
static const ble_uuid128_t uuid_ext2a =
    BLE_UUID128_INIT(0xdf, 0x7f, 0xdf, 0x09, 0x8f, 0x11, 0x8f, 0x82, 0xad, 0x49, 0xfe, 0x89, 0xbe, 0xe9, 0x7d, 0xab);
static const ble_uuid128_t uuid_ext2c =
    BLE_UUID128_INIT(0x06, 0x2b, 0xf7, 0x31, 0x0c, 0x63, 0x39, 0xa9, 0x7d, 0x42, 0x58, 0x92, 0x51, 0x3f, 0x48, 0xcc);
static const ble_uuid128_t uuid_ext2e =
    BLE_UUID128_INIT(0xf9, 0xc0, 0xfc, 0x5f, 0x75, 0x32, 0x58, 0x82, 0xad, 0x49, 0xfe, 0x89, 0xbe, 0xe9, 0x7d, 0xab);
static const ble_uuid128_t uuid_ext32 =
    BLE_UUID128_INIT(0x80, 0xb3, 0xe8, 0x09, 0x98, 0x6f, 0xaf, 0x8e, 0xb5, 0x40, 0x55, 0x69, 0x7e, 0xbc, 0xac, 0x3d);
...
static const ble_uuid128_t uuid_report_rate =
    BLE_UUID128_INIT(0xcb, 0x6e, 0x48, 0x80, 0xdf, 0x95, 0x57, 0x95, 0xee, 0x4d, 0x24, 0x5a, 0x10, 0x55, 0x9d, 0x67);
static const ble_uuid128_t uuid_generic_dsc =
    BLE_UUID128_INIT(0x79, 0xf9, 0xa4, 0xed, 0xbb, 0xe3, 0xd2, 0x9c, 0x5b, 0x49, 0x58, 0xf3, 0x8c, 0xdf, 0x46, 0xb7);
...
static int chr_access(uint16_t conn_handle, uint16_t attr_handle, struct ble_gatt_access_ctxt *ctxt, void *arg);
...
static const struct ble_gatt_svc_def gatt_services[] = {
  {
      ...
      .characteristics =
          (struct ble_gatt_chr_def[]){
              { .uuid = &uuid_base_status.u,
                .access_cb = chr_access,
                .flags = BLE_GATT_CHR_F_READ,
                .arg = (void *)CHR_BASE_STATUS },
              { .uuid = &uuid_base_config.u,
                .access_cb = chr_access,
                .flags = BLE_GATT_CHR_F_WRITE,
                .arg = (void *)CHR_BASE_CONFIG },
              { .uuid = &uuid_device_id.u,
                .access_cb = chr_access,
                .flags = BLE_GATT_CHR_F_READ,
                .arg = (void *)CHR_DEVICE_ID },
              { 0 },
          },
  },
  {
      ...
      .characteristics =
          (struct ble_gatt_chr_def[]){
              ...
              { .uuid = &uuid_cmd.u,
                ...
                .flags = BLE_GATT_CHR_F_WRITE_NO_RSP,
                .arg = (void *)CHR_CMD },
              { .uuid = &uuid_composite.u,
                .access_cb = chr_access,
                .flags = BLE_GATT_CHR_F_WRITE_NO_RSP,
                .arg = (void *)CHR_COMPOSITE },
              { .uuid = &uuid_fwupg.u,
                .access_cb = chr_access,
                .flags = BLE_GATT_CHR_F_WRITE_NO_RSP,
                .arg = (void *)CHR_FWUPG },
...
static void log_write_head(const char *what, uint16_t tag, const struct os_mbuf *om)
{
  ...
  ESP_LOGI(TAG, "%s %uB (tag %u) %02x %02x %02x %02x %02x %02x %02x %02x", what, (unsigned)total, (unsigned)tag,
...
static int chr_access(uint16_t conn_handle, uint16_t attr_handle, struct ble_gatt_access_ctxt *ctxt, void *arg)
{
  ...
  if (ctxt->op == BLE_GATT_ACCESS_OP_READ_CHR) {
    ...
    if (!is_input_chr(tag)) {
      ...
      ESP_LOGI(TAG, "input poll read (handle=0x%04x, tag=%u)", attr_handle, (unsigned)tag);
    }
    switch (tag) {
    case CHR_INPUT05:
  ...
  if (ctxt->op == BLE_GATT_ACCESS_OP_WRITE_DSC) {
    ...
    ESP_LOGI(TAG, "report rate dsc write (handle=0x%04x, %uB: %02x %02x)", attr_handle, (unsigned)len, data[0],
             len > 1 ? data[1] : 0);
    return 0;
  }
  ...
  case CHR_FWUPG: {
    ...
    if (total > sizeof(wbuf)) {
      ESP_LOGW(TAG, "fwupd block %uB over %uB buffer", (unsigned)total, (unsigned)sizeof(wbuf));
    }
...
static int gap_event_cb(struct ble_gap_event *event, void *arg)
{
  ...
  case BLE_GAP_EVENT_CONNECT: {
    ...
    ESP_LOGI(TAG,
             "ACL connected (conn=%u, identity=%s, itvl=%u units / %u us, mtu=%u, "
             "peer id/ota type %u/%u)",
             event->connect.conn_handle, ns2_identity_name(identity), desc.conn_itvl, (unsigned)desc.conn_itvl * 1250u,
             (unsigned)slot->mtu, desc.peer_id_addr.type, desc.peer_ota_addr.type);
  ...
  case BLE_GAP_EVENT_CONN_UPDATE: {
    ...
    ESP_LOGI(TAG, "conn update (conn=%u, itvl=%u units / %u us, mtu=%u, status=%d)", event->conn_update.conn_handle,
             itvl, (unsigned)itvl * 1250u, (unsigned)ble_att_mtu(event->conn_update.conn_handle),
             event->conn_update.status);
    break;
  }
  case BLE_GAP_EVENT_ENC_CHANGE: {
    const conn_slot_t *slot = conn_slot(event->enc_change.conn_handle);
    ESP_LOGI(TAG, "encryption change (conn=%u, identity=%s, status=%d)", event->enc_change.conn_handle,
             ns2_identity_name(slot ? slot->identity : NS2_ID_PRO), event->enc_change.status);
    break;
  }
  case BLE_GAP_EVENT_DISCONNECT: {
    ...
    ESP_LOGI(TAG, "disconnected reason=0x%02x (identity=%s)", event->disconnect.reason, ns2_identity_name(identity));
  ...
  case BLE_GAP_EVENT_SUBSCRIBE: {
    ...
    if (slot != NULL) {
      if (event->subscribe.attr_handle == s_h.input05) {
        ...
        slot->input_priv_handle = slot->input_priv_notify ? event->subscribe.attr_handle : 0;
    ...
    ESP_LOGI(TAG, "subscribe 0x%04x notify=%d", event->subscribe.attr_handle, event->subscribe.cur_notify);
    break;
  }
...
static void adv_start_instance(uint8_t instance, int legacy_pdu, const uint8_t payload[31], const uint8_t addr[6])
{
  ...
  const int rc_conf = ble_gap_ext_adv_configure(instance, &params, NULL, gap_event_cb, NULL);
  if (rc_conf != 0) {
  ...
  ESP_LOGI(TAG, "advertising started (instance=%u, %s pdu, identity=%u)", instance, legacy_pdu ? "legacy" : "extended",
           (unsigned)s_adv_identity[instance]);
}
...
static void notify(uint16_t conn_handle, uint16_t attr_handle, bool enabled, const uint8_t *data, size_t len)
{
  if (!enabled) {
    return;
  }
  ...
  if (rc != 0) {
    ...
    if (slot != NULL) {
      if (slot->tx_fail == 0) {
        ESP_LOGW(TAG, "notify failed rc=%d (conn=%u, handle=0x%04x, len=%u, mtu=%u)", rc, conn_handle, attr_handle,
                 (unsigned)len, (unsigned)ble_att_mtu(conn_handle));
      }
      slot->tx_fail++;
      slot->tx_rc = rc;
    }
...
void ble_controller_notify_input_09(uint16_t conn_handle, const uint8_t report[63])
{
  ...
  const uint16_t handle = slot->input_priv_handle != 0 ? slot->input_priv_handle : s_h.input09;
...
static void host_idle_timer_cb(void *arg)
{
  for (size_t i = 0; i < BLE_CTL_CONN_MAX; i++) {
    if (s_conn[i].used && ns2_session_conn_idle_expired(s_conn[i].conn_handle)) {
      ESP_LOGW(TAG, "host idle timeout, disconnecting conn=%u", s_conn[i].conn_handle);
