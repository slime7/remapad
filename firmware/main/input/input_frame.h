...
#define INPUT_FRAME_MAX_LEN (INPUT_FRAME_HEADER_LEN + INPUT_FRAME_MAX_PAYLOAD + INPUT_FRAME_CRC_LEN)
/** 线格式上限：len 字段是单字节，解码器最多收这么多字节的载荷。 */
#define INPUT_FRAME_WIRE_MAX_PAYLOAD 255u
#define INPUT_FRAME_WIRE_MAX_LEN (INPUT_FRAME_HEADER_LEN + INPUT_FRAME_WIRE_MAX_PAYLOAD + INPUT_FRAME_CRC_LEN)
