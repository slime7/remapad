...
static const uint8_t k_rumble[32] = {
    0x7C, 0x04, 0x80, 0x01, 0x97, 0x63, 0x20, 0x2C, 0x3B, 0x98, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x7C, 0x04, 0x00, 0x01, 0x00, 0x99, 0x20, 0x2C, 0x3B, 0x98, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00,
};
...
static void writes_queue_in_order_with_raw_bytes(void)
{
    ...
    const uint8_t want_rumble[2 + sizeof(k_rumble)] = {
        ...
        0x7C, 0x04, 0x80, 0x01, 0x97, 0x63, 0x20, 0x2C, 0x3B, 0x98, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x7C, 0x04, 0x00, 0x01, 0x00, 0x99, 0x20, 0x2C, 0x3B, 0x98, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00,
    };
...
HOST_TEST_SUITE(suite_dp_capture, "dp_capture 主机输出原始采集",
                ...
                {"队列写满丢弃后来的写入，已排队的原样保留",
                 full_queue_drops_newest_and_keeps_queued},
