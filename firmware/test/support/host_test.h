...
#define CHECK_EQ(actual, expected)                                                                                     \
  host_test_expect_u64((uint64_t)(actual), (uint64_t)(expected), #actual " == " #expected, __FILE__, __LINE__)
...
#define HOST_TEST_SUITE(symbol, suite_name, ...)                                                                       \
  ...
  const host_test_suite_t symbol = { suite_name, symbol##_cases, sizeof(symbol##_cases) / sizeof(symbol##_cases[0]) };
